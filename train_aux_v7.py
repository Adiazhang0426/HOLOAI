...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default=r'ultralytics\cfg\models\v7\yolov7-e6e.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=r'YOLOv7\yolov7dataset.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default=r'YOLOv7\hyp.scratch.p5.yaml', help='hyperparameters path')
