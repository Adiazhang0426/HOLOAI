...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=r'E:\Adia\研究生工作\2023 IPI数据及结冰数据集\ipi\yolov7-main\runs\train\exp36\weights\best.pt', help='model.pt path(s)')
    parser.add_argument('--data', type=str, default=r'H:\ice_particle\2-case2-pw180-pa60-0.56\reconstruct\1\Image_20230524182723_w1440_h1080_1', help='*.data path')
